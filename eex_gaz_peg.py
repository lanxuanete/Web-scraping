...
def get_response():
    ...
    driver.get("https://www.eex.com/en/market-data/natural-gas/futures#%7B%22snippetpicker%22%3A%22298%22%7D")
    ...
    # year
    driver.find_element(By.XPATH, '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[1]/td[8]').click()
    time.sleep(5)
    for i_year in range(3, 7):
        xpath = '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[' + str(i_year) + ']/td[8]'
        driver.find_element(By.XPATH, xpath).click()
        time.sleep(5)
    # season
    driver.execute_script("var q=document.documentElement.scrollTop=0")
    driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/main/div/div/div[8]/div[1]/div/div[2]/div[2]').click()
    time.sleep(5)
    driver.find_element(By.XPATH, '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[1]/td[8]').click()
    time.sleep(5)
    for i_season in range(3, 7):
        xpath = '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[' + str(i_season) + ']/td[8]'
        driver.find_element(By.XPATH, xpath).click()
        time.sleep(5)
    # quarter
    driver.execute_script("var q=document.documentElement.scrollTop=0")
    driver.find_element(By.XPATH, '//*[@id="symbolheader_ngfpeg"]/div/div[2]/div[3]').click()
    time.sleep(5)
    driver.find_element(By.XPATH, '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[1]/td[8]').click()
    time.sleep(5)
    for i_quarter in range(3, 8):
        xpath = '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[' + str(i_quarter) + ']/td[8]'
        driver.find_element(By.XPATH, xpath).click()
        time.sleep(5)
    # month
    driver.execute_script("var q=document.documentElement.scrollTop=0")
    driver.find_element(By.XPATH, '//*[@id="symbolheader_ngfpeg"]/div/div[2]/div[4]').click()
    time.sleep(5)
    driver.find_element(By.XPATH, '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[1]/td[8]').click()
    time.sleep(5)
    for i_month in range(3, 8):
        xpath = '//*[@id="baseloadwidget_ngfpeg"]/table/tbody/tr[' + str(i_month) + ']/td[8]'
        driver.find_element(By.XPATH, xpath).click()
        time.sleep(5)
    ...
    #
    result = proxy.har
    with open('result/result_gaz_peg.txt', 'w') as f:
        json.dump(result, f)
...
if __name__ == '__main__':
    ...
    df = pd.read_excel("eex_response_url.xlsx", sheet_name='gaz_PEG')
    ...
    if last_day_excel == yesterday:
        ...
        with open('./result/result_gaz_peg.txt', 'r') as f:
            result = json.load(f)
                ...
                if url in _url:
                    ...
                    for i in range(len(date_list)):
                        if str(date_list[i]) in dict_info:
                            ...
                            ws.cell(row=last_row_num + 1 + i, column=27, value=today)
